...
const Header = () => {
    ...
    return (
        <header className='flex flex-col w-full gap-6 p-4 bg-gray-800/60 p-4 dark:bg-gray-900 hover:bg-gray-700 dark:hover:bg-gray-800 shadow-md rounded-lg animate-slide-from-down-and-fade-1'>
                    ...
                    <Avatar className='w-15 h-15'>
                        <AvatarImage src={CONFIG.avatar} asChild>
                            <Image
                                ...
                                height={64}
                                priority={true}
                                className='rounded-full border-1 border-gray-700'
                            />
                        </AvatarImage>
                ...
                <TooltipProvider delayDuration={70}>
                    {!showIcons && (
                        <Tooltip>
                            ...
                            <TooltipContent
                                side='bottom'
                                className='bg-gray-700 text-xs text-white rounded'
                            >
                                {'Connect with me'}
                            </TooltipContent>
                        </Tooltip>
